...
# 25 "/usr/include/bits/error.h" 3 4
extern void __error_alias (int __status, int __errnum, __const char *__format, ...) __asm__ ("" "error")


  __attribute__ ((__format__ (__printf__, 3, 4)));
extern void __error_noreturn (int __status, int __errnum, __const char *__format, ...) __asm__ ("" "error")
...
extern void __error_at_line_alias (int __status, int __errnum, __const char *__fname, unsigned int __line, __const char *__format, ...) __asm__ ("" "error_at_line")




  __attribute__ ((__format__ (__printf__, 5, 6)));
extern void __error_at_line_noreturn (int __status, int __errnum, __const char *__fname, unsigned int __line, __const char *__format, ...) __asm__ ("" "error_at_line")
